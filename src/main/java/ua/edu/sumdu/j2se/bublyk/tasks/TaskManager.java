...
import ua.edu.sumdu.j2se.bublyk.tasks.controller.MainController;
...
public class TaskManager extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		stage.getIcons().add(new Image(Objects.requireNonNull(TaskManager.class.getResourceAsStream("TaskMangerIcon.png"))));
